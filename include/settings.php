...
function update_config()
{
  ...
  if (is_file($config['cacert'])) {
    ...
    if (isset($data['subject']['CN'])) {
      $config['common'] = $data['subject']['CN'];
    }
    if (isset($data['subject']['OU'])) {
      $config['orgunit'] = $data['subject']['OU'];
    }
    if (isset($data['subject']['O'])) {
      $config['orgName'] = $data['subject']['O'];
    }
    if (isset($data['subject']['emailAddress'])) {
      $config['contact'] = $data['subject']['emailAddress'];
    }
    if (isset($data['subject']['L'])) {
      $config['city'] = $data['subject']['L'];
    }
    if (isset($data['subject']['ST'])) {
      $config['state'] = $data['subject']['ST'];
    }
    if (isset($data['subject']['C'])) {
      $config['country'] = $data['subject']['C'];
    }
  }
  /*
