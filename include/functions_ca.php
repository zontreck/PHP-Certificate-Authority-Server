    ...
    <table style="width: 400px;">
      ...
      <tr>
        ...
        <td><input type="radio" name="cert_dn[keySize]" value="1024" /> 1024bits <input type="radio"
            name="cert_dn[keySize]" value="2048" /> 2048bits<input type="radio" name="cert_dn[keySize]" value="4096"
            checked /> 4096bits</td>
      </tr>
      <tr>
      ...
      <table style="width: 400px;">
        ...
        <tr>
          ...
          <td><input type="radio" name="rename_ext" value="FALSE" checked />Do not Rename<br><input type="radio"
              name="rename_ext" value="crl" /> Rename to crl</td>
        </tr>
        <tr>
          <th>Rename Filename to <BR>
            <?PHP print $this_ca; ?>
          </th>
