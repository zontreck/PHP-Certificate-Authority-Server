...
function check_key_passphrase_form($my_values = array('key_name' => '::zz::'))
{
  ...
  <form action="index.php" method="post">
    ...
    <table style="width: 400px;">
      <tr>
        <td width=100>Passphrase:
        <td><input type="password" name="pass" />
      <tr>
        <td>
        <td><input type="submit" value="Check Passphrase" />
      <tr>
        <td width=100>Private Key:
        <td><select name="key_name" rows="6">
            <option value="">--- Select a key
              ...
              while (($file = readdir($dh)) !== false) {
                if (($file !== ".htaccess") && is_file($config['key_path'] . $file)) {
                  ...
                  if ($my_values['key_name'] == "$name$ext")
  ...
  <p>
    ...
    <form action="index.php" method="post">
      ...
      <table style="width: 400px;">
        ...
        <tr>
          <td>
          <td><input type="submit" value="Get Public Key">
      </table>
    </form>
    <?php
    } else
      ...
      <table style="width: 400px;">
        ...
        <tr>
          ...
          <td><input type="radio" name="rename_ext" value="FALSE" checked />Do not Rename<br><input type="radio"
              name="rename_ext" value="key" /> Rename to key</td>
        </tr>
        <tr>
          <th>Strip Passphrase</th>
          <td><input type="radio" name="strip_passphrase" value="FALSE" checked /> No <input type="radio"
              name="strip_passphrase" value="TRUE" /> Yes</td>
        </tr>
        <tr>
          <th>Puttygen Compatable</th>
          <td><input type="radio" name="puttygen" value="FALSE" checked /> No <input type="radio" name="puttygen"
              value="TRUE" /> Yes</td>
        </tr>
        <tr>
          <td width=100>Name:
        ...
        <tr>
          <td>
          <td><input type="submit" value="Get Private Key">
      </table>
    </form>
    <?php
    } else
